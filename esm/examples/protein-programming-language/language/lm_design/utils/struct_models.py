...
from language.lm_design.utils.tensor import add_eos_bos, is_1hot_tensor
from torch import nn
...
from language.lm_design.utils.linear_projection import LinearProjectionDistogramModel
